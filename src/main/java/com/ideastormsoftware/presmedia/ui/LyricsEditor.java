...
import com.ideastormsoftware.presmedia.util.Joiner;
import java.util.Arrays;
import java.util.List;

public class LyricsEditor extends javax.swing.JFrame {
    private final Lyrics lyrics;
    private final Runnable callback;

    public LyricsEditor(Lyrics lyrics, Runnable callback) {
        this.lyrics = lyrics;
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(236, 428));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        List<String> lines = Arrays.asList(lyricsField.getText().split("\\n"));
        lyrics.setLines(lines);
        lyrics.setTitle(titleField.getText());
        if (callback != null)
            callback.run();
        setVisible(false);
